...
namespace {
struct qt_meta_tag_ZN11StaffWindowE_t {};
} // unnamed namespace

template <> constexpr inline auto StaffWindow::qt_create_metaobjectdata<qt_meta_tag_ZN11StaffWindowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<StaffWindow, qt_meta_tag_ZN11StaffWindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject StaffWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11StaffWindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11StaffWindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11StaffWindowE_t>.metaTypes,
    nullptr
} };
...
void *StaffWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11StaffWindowE_t>.strings))
